...
class ChatCompletionRequest(BaseModel):
    ...
    type: Optional[str] = Field("github", description="Type of repository (e.g., 'github', 'gitlab', 'bitbucket', 'gitee')")
    ...
    branch: Optional[str] = Field(None, description="Specific branch to clone from the repository")
